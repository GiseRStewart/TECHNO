...
createApp({
    data() {
        return {
        url:"https://technopower.pythonanywhere.com/usuarios", // Retorna todos los registro de la tabla productos
        usuarios:[],
        error:false,
        cargando:true
        }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://technopower.pythonanywhere.com/borrarUsuario/'+id;
            var options = {
                method: 'DELETE',
