...
createApp({
    data() {
        return {
        url:"https://technopower.pythonanywhere.com/productos", // Retorna todos los registro de la tabla productos
        notebook:[],
        error:false,
        cargando:true
        }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://technopower.pythonanywhere.com/delete/'+id;
            var options = {
                method: 'DELETE',
